<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <input id="dateofbirth" name="dateofbirth" type="date" class="mt-1 block w-full rounded-lg border border-gray shadow-md" value="{{ old('dateofbirth', $user->dateofbirth) }}" required autofocus autocomplete="bday">
